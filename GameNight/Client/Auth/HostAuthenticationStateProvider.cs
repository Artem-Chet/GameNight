...
namespace GameNight.Client.Auth;

public class HostAuthenticationStateProvider(NavigationManager navigation, IHttpClientFactory httpClientFactory, ILogger<HostAuthenticationStateProvider> logger)
    : AuthenticationStateProvider
{
    ...
    private HttpClient httpClient = httpClientFactory.CreateClient(AuthDefaults.UnAuthorizedClientName);
    ...
    private async Task<ClaimsPrincipal> FetchUser()
    {
        ...
        try
        {
            logger.LogInformation("{clientBaseAddress}", httpClient.BaseAddress?.ToString());
